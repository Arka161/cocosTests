...
void Pipe::SpawnPipe(cocos2d::Layer *layer)
{
	...
	if (random < LOWER_SCREEN_PIPE_THRESHOLD)
		...
		topPipe->setPosition(Point(visibleSize.width / 2 + topPipe->getContentSize().width + origin.x + 250 , topPipePosition));
		...
		auto topPipeAction = MoveBy::create(PIPE_MOVEMENT_SPEED, Point(-visibleSize.width * 1.5, 0));
		auto bottomPipeAction = MoveBy::create(PIPE_MOVEMENT_SPEED, Point(-visibleSize.width * 1.5, 0));
